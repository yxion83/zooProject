                    ...
                    switch (commandWords[0])
                    {
                        ...
                        case "sort":
                            try
                            {
                                ...
                                {
                                    result = zoo.SortGuest(commandWords[2], commandWords[3],);
                        ...
                        case "search":
                            if (commandWords[1] == "binary")
                            {
                                ...
                                animals.Objects = new List<Animal>().Cast<object>().ToList();
                                ...
                                while (minPosition <= maxPosition)
                                {
                                    ...
                                    loopCounter++;
                                    int compare = string.Compare(animalName, animals.Objects[middlePosition]);
